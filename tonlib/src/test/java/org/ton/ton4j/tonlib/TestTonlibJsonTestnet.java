...
public class TestTonlibJsonTestnet {
  ...
  public void testTonlibGetBlockTransactionsPaginated() {
    ...
    ShortTxId txi =
        blockTransactions.getTransactions().get(blockTransactions.getTransactions().size() - 1);
  ...
  @Test
  public void testTonlibGetConfigSingle18() {
    Tonlib tonlib = Tonlib.builder().pathToTonlibSharedLib(tonlibPath).testnet(true).build();
    ConfigParams18 c = tonlib.getConfigParam18();
    log.info("config18 {}", c);
    assertThat(c).isNotNull();
  }
